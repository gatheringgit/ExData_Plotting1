plot2 <- function(){
                ...
                ## create plot2, and then copy to a png
                        plot(edaDataset_final$calendar_day_by_minute, edaDataset_final$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
